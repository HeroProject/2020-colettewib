...
class AbstractSICConnector(object):
    ...
    def __init__(self, server_ip: str, robot: RobotType):
        """
    ...
    def on_robot_event(self, event: str):
    ...
    def on_audio_language(self, language_key: str):
    ...
    def on_audio_intent(self, *args, intent_name: str):
    ...
    def on_new_audio_file(self, audio_file: str):
    ...
    def on_speech_text(self, text: str):
    ...
    def on_new_picture_file(self, picture_file: str):
    ...
    def set_idle(self):
        ...
        if not self.robot == RobotType.PEPPER:
    ...
    def wake_up(self):
        ...
        if not self.robot == RobotType.NAO:
            raise IllegalActionForRobot()
    ...
    def go_to_posture(self, posture: str, speed: float = 1.0):
        """
        Let the robot go to a predefined posture.

        Predefined postures for pepper are: Stand or StandInit, StandZero, and	Crouch
        See: http://doc.aldebaran.com/2-8/family/pepper_technical/postures_pep.html#pepper-postures
        ...
        :return:
        """
        self.__send('action_posture', posture + ';' + str(speed) if 0.0 <= speed <= 1.0 else posture + ';1.0')
    ...
    def __listen(self, message):
        ...
        if channel == 'events_robot':
            ...
            self.on_emotion_detected(emotion=data)
        elif channel == 'robot_posture_changed':
            self.on_posture_changed(posture=data)
